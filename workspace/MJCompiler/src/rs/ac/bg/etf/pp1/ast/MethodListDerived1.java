...
public class MethodListDerived1 extends MethodList {

    private MethodList MethodList;
    private MethodDecl MethodDecl;

    public MethodListDerived1 (MethodList MethodList, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodListDerived1(\n");
