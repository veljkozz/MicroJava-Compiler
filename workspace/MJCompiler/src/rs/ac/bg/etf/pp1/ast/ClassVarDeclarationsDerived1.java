...
public class ClassVarDeclarationsDerived1 extends ClassVarDeclarations {

    private Type Type;
    private ClassVarList ClassVarList;

    public ClassVarDeclarationsDerived1 (Type Type, ClassVarList ClassVarList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarDeclarationsDerived1(\n");
